...
const APPNAME = {
    localhost: {
        ...
        money: '金币',
        gameunit: '罐头',
        gameUrl: '//dev-activity.huanting.top',
        h5Url: 'localhost',
        appType: 2,
    ...
    'dev-h5.njxianyuwl.cn': {
        ...
        shortName: shortName,
        appname: appname,
        proBaseURL: '//dev-api.njxianyuwl.cn',
        proBaseURL_USER: '//dev-api.njxianyuwl.cn',
        proBaseURL_PIC: '//dev-api.njxianyuwl.cn',
        rule: YIYA_RULE,
        cardUrl: cardUrl,
        staticUrl: '//s3.njxianyuwl.cn/static/h5_static',
        baseColor: '#fff',
        ...
        yiaIos: yiaIos,
        downUrl: 'https://www.gxjiaman.com/app/downloads?channel=101275 ',
        logo: '//s3.njxianyuwl.cn/static/h5_static/yeke_logo.png',
        unit: '钻石',
        money: '金币',
        gameunit: '罐头',
        gameUrl: '//dev-activity.huanting.top',
    ...
    'pre-h5.njxianyuwl.cn': {
        companyName: companyName,
        companyAdress: companyAdress,
        shortName: shortName,
        appname: appname,
        proBaseURL: '//pre-api.njxianyuwl.cn',
        proBaseURL_USER: '//pre-api.njxianyuwl.cn',
        proBaseURL_PIC: '//pre-api.njxianyuwl.cn',
        rule: YIYA_RULE,
        cardUrl: cardUrl,
        staticUrl: '//s1.huanting.top/static/h5_static',
        baseColor: '#fff',
        loadingColor: '#4587F7',
        yiaIos: yiaIos,
        downUrl: 'https://www.gxjiaman.com/app/downloads?channel=101275 ',
        logo: '//s0.gxjiaman.com/static/h5_static/buz/buz_logo.png',
        unit: '钻石',
        money: '金币',
        gameunit: '罐头',
        gameUrl: '//pre-activity.huanting.top',
        h5Url: 'localhost',
        appType: 2,
        createTime: '2026年3月25日',
    },
    'h5.njxianyuwl.cn': {
        ...
        shortName: shortName,
        appname: appname,
        proBaseURL: '//api.njxianyuwl.cn',
        proBaseURL_USER: '//api.njxianyuwl.cn',
        proBaseURL_PIC: '//api.njxianyuwl.cn',
        rule: YIYA_RULE,
        cardUrl: cardUrl,
        staticUrl: '//s3.njxianyuwl.cn/static/h5_static',
        baseColor: '#fff',
